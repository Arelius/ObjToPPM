...
obj_positions* obj_load_mesh(const char* filename)
{
    ...
    while(*curr != '\0')
    {
        ...
        else if(check_match(curr, "usemtl") && false)
        {
            curr += 6;
    ...
    obj_positions* mesh = new obj_positions();

    mesh->vertex_count = position_count;
    mesh->locations = positions;
